...
/*</DEBUG>*/
                 ...
                 */
                // 开启连接追踪
                // enable : true / use pseudo click-handler (treat middle click and open contextmenu as left click). A right click (or any click that opens the context menu) on a link will be tracked as clicked even if "Open in new tab" is not selected.
                //              false / (default), nothing will be tracked on open context menu or middle click. The context menu is usually opened to open a link / download in a new tab therefore you can get more accurate results by treat it as a click but it can lead to wrong click numbers.
