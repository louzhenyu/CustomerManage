...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>支付方式管理</title>
    <style>
    .payMentListArea{padding:50px 30px;}
	/***弹出，创建版块，创建期刊***/
	...
	.jui-dialog-payMent .searchInput input{height:32px;}
	.jui-dialog-payMent .searchInput input[disabled='disabled']{background:#ccc;}
	.jui-dialog-payMent .btnWrap .commonBtn{width:80px;height:27px;line-height:27px;margin-top:20px;}
	.jui-dialog-payMent .cancelBtn{margin-left:60px;}
	
	.jui-dialog-payMent .radioBox{float:left;height:22px;line-height:19px;margin-left:20px;padding-left:22px;background:url(../styles/images/radio.png) no-repeat left center;cursor:pointer;}
	.jui-dialog-payMent .radioBox.on{background:url(../styles/images/skin/bg02/radio00.png) no-repeat left center;}
        ...
        <table class="dataTable" style="display:inline-table;">
            <thead>
                <tr class="title">
                    ...
                    <th>操作</th>
                    <th width="300">支付方式</th>
                    <th width="300">支付编码</th>
                    <th>状态</th>
                </tr>
            </thead>
...
<div id="jui-dialog-AlipayWap" class="jui-dialog jui-dialog-payMent">
    ...
    <div class="payMentContent">
        ...
        <div class="commonSelectWrap">
            <em class="tit"><span class="fontRed">*</span> 卖家淘宝账号</em>
        ...
        <div class="commonSelectWrap">
            <em class="tit"><span class="fontRed">*</span> 私钥</em>
...
<div id="jui-dialog-WXJS" class="jui-dialog jui-dialog-payMent">
    ...
    <div class="payMentContent">
        ...
        <div class="commonSelectWrap">
            <em class="tit"><span class="fontRed">*</span> 身份标识</em>
