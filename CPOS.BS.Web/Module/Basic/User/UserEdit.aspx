...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="<%=StaticUrl+"/module/basic/user/Controller/UserEditCtl.js"%>" type="text/javascript"></script>
                    ...
                    <div class="z_detail_tb" style="">
                        ...
                        <table class="z_main_tb">
                            ...
                            <tr class="z_main_tb_tr">
                                ...
                                <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"><font color="red">*</font>邮箱</td>
                                <td class="z_main_tb_td2" style="padding-top:0px;">
                                    <div id="txtEmail"></div>
                                </td>
                                <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;">QQ</td>
                                <td class="z_main_tb_td2" style="padding-top:0px;">
                                    <div id="txtQQ"></div>
                                </td>
                            </tr>
