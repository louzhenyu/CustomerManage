...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    <title>相片内容</title>
    <script src="Controller/AlbumImagesEditCtl.js" type="text/javascript"></script>
    <script src="Model/AlbumVM.js" type="text/javascript"></script>
    <script src="Store/AlbumVMStore.js" type="text/javascript"></script>
    <script src="View/AlbumImagesEditView.js" type="text/javascript"></script>
    ...
    <script charset="utf-8" type="text/javascript" src="/Framework/Javascript/Other/kindeditor/kindeditor-min.js"></script>
    ...
    <div>
        <div class="m10 article">
            <div style="width: 100%; padding: 0px; border: 1px solid #d0d0d0;">
                <div id="tabInfo" style="height: 251px; background: rgb(241, 242, 245);">
                    <div class="z_detail_tb" style="width: 550px">
                        ...
                        <table class="z_main_tb">
                            ...
                            <%-- <tr class="z_main_tb_tr">
                                <td class="z_main_tb_td" style="vertical-align: top; line-height: 22px; width: 70px;">
                                    <font color="red">*</font>相片链接
                                </td>
                                <td class="z_main_tb_td2" colspan="5" style="vertical-align: top; line-height: 22px;">
                                    <div style="position: relative;">
                                        <div id="txtImageURL" style="overflow: hidden; margin-top: 0px;">
                                        </div>
                            ...
                            <tr class="tr-Image">
                                <td colspan="6">
                                    <div class="uploadImageItem">
                                        <span class="imagetit">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<font style="color: Red">*</font>图片</span>
