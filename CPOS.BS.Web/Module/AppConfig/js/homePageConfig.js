define(['jquery', 'homePageTemp', 'touchslider', 'template', 'kindeditor', 'pagination'], function ($, temp,touchslider) {
        ...
        editLayerEvent: function () {
            ...
            this.ele.editLayer.delegate(".jsCancelBtn", "click", function (e) {
                ...
                if (this.value == "ad-2") {
                    ...
                    $this.parent().siblings(".infoContainer").show().children(".jsChooseBtn").show();
                }
