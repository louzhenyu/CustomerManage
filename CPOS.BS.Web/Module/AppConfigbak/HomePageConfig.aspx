...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>首页管理</title>
    <link rel="stylesheet" href="<%=StaticUrl+"/module/AppConfigbakbak/css/jquery-ui.min.css"%>" />
    <link rel="stylesheet" href="<%=StaticUrl+"/Framework/Javascript/Other/kindeditor/themes/default/default.css"%>" />
    <link rel="stylesheet" href="<%=StaticUrl+"/module/AppConfigbak/css/style.css"%>" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" src="<%=StaticUrl+"/Module/static/js/lib/require.js"%>" defer async="true" data-main="<%=StaticUrl+"/module/AppConfigbak/js/main"%>"></script>
</asp:Content>
