...
namespace JIT.CPOS.BS.Web.Module.AppConfigbak.Handler
{
    /// <summary>
    /// homepageHandleold 的摘要说明
    /// </summary>
    public class homepageHandleold : JIT.CPOS.BS.Web.PageBase.JITCPOSAjaxHandler
    {
        ...
        public string GetHomePageConfigInfo()
        {
            ...
            try
            {
                ...
                if (homeList != null && homeList.Length > 0)
                {
                    ...
                    {
                        content.navList.itemList = new List<ItemEntity>();
                    }
