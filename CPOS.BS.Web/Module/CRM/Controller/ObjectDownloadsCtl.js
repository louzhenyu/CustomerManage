...
function fnSearch() {
    Ext.getStore("ObjectDownloadsStore").proxy.url = JITPage.HandlerUrl.getValue() + "&method=ObjectDownloads_query";
    Ext.getStore("ObjectDownloadsStore").pageSize = JITPage.PageSize.getValue();
    Ext.getStore("ObjectDownloadsStore").proxy.extraParams = {
        //form: Ext.JSON.encode(Ext.getCmp("searchPanel").getValues())
        ObjectId: getUrlParam("ObjectId")
    };

    Ext.getStore("ObjectDownloadsStore").load();
}
