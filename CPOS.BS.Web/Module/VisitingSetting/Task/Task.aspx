...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/TaskCtl.js" type="text/javascript"></script>
    <script src="Model/TaskVM.js" type="text/javascript"></script>
    <script src="Store/TaskVMStore.js" type="text/javascript"></script>
    <script src="View/TaskView.js" type="text/javascript"></script>
</asp:Content>
