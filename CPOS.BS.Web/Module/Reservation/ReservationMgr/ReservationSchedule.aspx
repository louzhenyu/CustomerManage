...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/Framework/javascript/Biz/OrderNo.js" type="text/javascript"></script>
     <script src="Controller/ReservationScheduleCtl.js" type="text/javascript"></script>
    <script src="Model/ReservationScheduleVM.js" type="text/javascript"></script>
    <script src="Store/ReservationScheduleStore.js" type="text/javascript"></script>
    <script src="View/ReservationScheduleListView.js" type="text/javascript"></script>
</asp:Content>
