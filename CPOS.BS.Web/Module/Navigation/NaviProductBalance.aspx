                ...
                <table class="z_main_tb">
                    ...
                    <tr class="z_main_tb_tr">
                        <td class="z_main_tb_td2" style="width:50px;height:150px"">&nbsp;</td>
                                ...
                                <button id="Button2" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"  data-flag='/module/stock/query/StoreQuery.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                            <button id="Button3" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"  data-flag='/module/order/inoutorders/AjOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button4" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"  data-flag='/module/order/inoutorders/MvInOutOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button5" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"  data-flag='/module/order/ccorders/CcOrder.aspx'>
