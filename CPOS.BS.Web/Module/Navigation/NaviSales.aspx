                ...
                <table class="z_main_tb">
                    ...
                    <tr class="z_main_tb_tr" style="vertical-align:top">
                        ...
                        <td class="z_main_tb_td2" style="">
                            <button id="Button1" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;" data-flag='/module/order/orders/SalesOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                            <button id="Button3" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"data-flag='/module/order/inoutorders/SalesOutOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button2" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"data-flag='/module/order/inoutorders/SalesReturnInOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button4" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"data-flag='/module/order/orders/SalesReturnOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="width: 138px">
                            <button id="Button5" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"data-flag='/module/order/inoutorders/deliveryorder.aspx'>
                    ...
                    <tr class="z_main_tb_tr">
                        ...
                        <td class="z_main_tb_td2" style="">
                            <button id="Button6" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"  data-flag='/module/order/inoutorders/BatchOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                            <button id="Button7" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;" data-flag='/module/order/inoutorders/BatchReturnOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button8" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;" data-flag='/module/order/inoutorders/RetailOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button9" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;"data-flag='/module/order/inoutorders/RetailReturnOrder.aspx'>
                        ...
                        <td class="z_main_tb_td2" style="">
                                <button id="Button10" type="button" class="x-btn-center" hidefocus="true" role="button" autocomplete="off" style="width: 138px; height: 138px;" data-flag='/module/order/inoutorders/PosOrder.aspx'>
