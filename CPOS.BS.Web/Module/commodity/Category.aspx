...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script id="tpl_addFrom" type="text/html">
        <form id="addFrom">
                    ...
                    <div class="jsAreaItem">
                        <div class="wrapPic">
                            ...
                            <span class="uploadBtn">
                                <input class="uploadImgBtn" type="file" /></span>
                            <div class="imgPanl">
                                <img src=""></div>
                        </div>
            ...
            <div class="commonSelectWrap">
                <em class="tit">商品佣金：</em>
                <label class="searchInput">
                    <input data-text="商品佣金" class="easyui-validatebox" data-options="required:true" data-flag="CommissionRate" name="CommissionRate" type="text" value=""><span style="position: absolute;right: -12px;">%</span>
                </label>
            </div>
        </form>
    </script>
