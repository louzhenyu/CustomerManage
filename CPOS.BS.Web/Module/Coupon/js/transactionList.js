define(['newJquery', 'tools', 'template',,'kkpager'], function () {
    var page =
        {
            ...
            initTables:function(){
                ...
                //请求结果
                this.loadData.getTransactionList(function(data){
                    var list = data.Data.TransactionArray;
                    list = list ? list : [];
                    ...
                    kkpager.generPageHtml({
                            ...
                            click: function (n) {
                                debugger;
	                            //这里可以做自已的处理
	                            this.init({ total: data.Data.TotalPage });
		                        //...
    ...
    page.loadData =
    {
        args:{
         ...
         //消费信息查询
        getTransactionList  : function (callback) {
            $.util.ajax({
                url: page.url,
                type: "post",
                data:
