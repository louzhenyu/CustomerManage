    ...
    var page =
        {
            ...
            initTables: function () {
                ...
                this.loadData.args.UseStatus = 2;
                //卡状态
                ...
                this.loadData.args.UseTime = useTime;

                //核销结束日期
                var useEndTime = $("#UseEndTime").val();
                this.loadData.args.UseEndTime = useEndTime;

                //核销人
                var createByName = $("#VipName").val();
                this.loadData.args.CreateByName = createByName;
            ...
            initEvent: function () {
                ...
                this.elems.exportBtn.click(function () {
                    ...
                    //核销起始日期
                    var useTime = $("#UseTime").val();
                    page.loadData.args.UseTime = useTime;

                    //核销结束日期
                    var useEndTime = $("#UseEndTime").val();
                    page.loadData.args.UseEndTime = useEndTime;

                    //核销人
                    var createByName = $("#VipName").val();
                    page.loadData.args.CreateByName = createByName;

                    //使用状态
                    page.loadData.args.UseStatus = 2;
        ...
        manageCouponSearch: function (callback) {
            ...
            $.util.ajax({
                ...
                data:
                {
                    ...
                    "CreateByName": this.args.CreateByName,
                    "UseTime": this.args.UseTime,
                    "UseEndTime": this.args.UseEndTime
                },
                success: function (data) {
