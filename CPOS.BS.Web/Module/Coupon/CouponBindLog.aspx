...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="allPage" id="section" data-js="js/couponBindLog">
	<span class="packup"></span>
	<div class="commonNav_coupon">
        <a href="javascript:void(0)" onclick='AddMid("CouponBind.aspx")'>分发优惠券</a>
        <a href="javascript:;" class="on" >分发记录</a>
    </div>
    ...
    <div class="contentArea_coupon">
        ...
        <div class="mana-card">
            <div class="mana-card-t">
                <ul class="clearfix">
                <li>
                        <input type="text" id="VipCriteria" placeholder="手机号/身份证/会员名" style="width:190px" />
                    </li>
                    <li>
                    ...
                    <li>
                        <input type="text" id="Operator" placeholder="操作人">
                    </li>
                    <li  class="mt1 inputDate" id="timeBetwwen" >
            	       <%--<input type="text" readonly date-format="yyyy-mm-dd" placeholder="使用日期"  id="beginTime" />--%>
                       <input type="text"  date-format="yyyy-mm-dd" id="BindingBeginTime" placeholder="分发起始日期"/>
                       <input type="text"  date-format="yyyy-mm-dd" id="BindingEndTime" placeholder="分发结束日期"/>
                    </li>
            ...
            <div class="mana-card-m" id="appendPage">
                <table id="queryResult"  width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <th align="center" scope="col">分发日期</th>
                        <%--<th align="center" scope="col">组段号</th>--%>
                        <th align="center" scope="col">操作人</th>
