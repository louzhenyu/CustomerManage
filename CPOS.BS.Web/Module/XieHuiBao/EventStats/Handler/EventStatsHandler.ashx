<%@ WebHandler Language="C#" Class="EventStatsHandler" %>
using System;
using System.Web;
using System.Linq;
using System.Data;
...
/// </summary>
public class EventStatsHandler : JITCPOSAjaxHandler
{
    ...
    public string EventStatsPageData(HttpContext pContext)
    {
        ...
        XieHuiBaoBLL bsbll = new XieHuiBaoBLL(CurrentUserInfo, "EventStats");
