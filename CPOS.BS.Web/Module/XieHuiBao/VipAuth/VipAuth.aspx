...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/VipAuthCtl.js?v1" type="text/javascript"></script>
    <script src="Model/VipAuthVM.js?v1" type="text/javascript"></script>
    <script src="Store/VipAuthVMStore.js?v1" type="text/javascript"></script>
    <script src="View/VipAuthView.js?v1" type="text/javascript"></script>
    <style type="text/css">
        ...
        <div class="m10 article">
            ...
            <div class="art-titbutton" style="margin: 0px; background: #E6E4E1;">
                ...
                <div class="view_Button" style="margin: 0px; background: #E6E4E1;">
                    <div id="tab10" class="z_posorder_head" onclick="fnSearchVip('0')">
                        <div style="width: 100px; height: 20px;">
                            全部</div>
                        <div id="txtNum0" style="height: 24px;">
                            0</div>
                    </div>
                    <div id="tab11" class="z_posorder_head" onclick="fnSearchVip('11')">
                        <div style="width: 100px; height: 20px;">
                            待提交</div>
                        <div id="txtNum1" style="height: 24px;">
                            0</div>
                    </div>
                    <div id="tab12" class="z_posorder_head" onclick="fnSearchVip('12')">
                        <div style="width: 100px; height: 20px;">
                            待认证</div>
                        <div id="txtNum2" style="height: 24px;">
                            0</div>
                    </div>
                    <div id="tab13" class="z_posorder_head" onclick="fnSearchVip('13')">
                        <div style="width: 100px; height: 20px;">
                            已认证</div>
