...
namespace JIT.CPOS.BS.Web
{
    public partial class Login2 : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (userList != null && userList.UserInfoList != null && userList.UserInfoList.Count > 0)
                {
                    ...
                    login_user.customer_id = "e703dbedadd943abacf864531decdac1";
            ...
            loggingSession.CurrentLoggingManager.Customer_Code = "lzlj";
        ...
        {
            return GetLjLoggingSession("", "e703dbedadd943abacf864531decdac1");
        }
