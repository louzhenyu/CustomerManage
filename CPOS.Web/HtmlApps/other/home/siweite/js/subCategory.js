define(['bdTemplate', 'tools'], function () {
    var page = {
        ...
        init: function () {
        	this.url = "/ApplicationInterface/Module/UnitAndItem/Item/Item.ashx?type=Product&Action=GetItemCategoryByParentId";
        ...
        renderCategoryList: function (list) {
        	debugger;
    		this.ele.categoryList.html(bd.template('tplListItem',{list:list}));
        }
    };
    self = page;
