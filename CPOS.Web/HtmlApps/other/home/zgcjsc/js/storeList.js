define(['jquery', 'template', 'tools','iscroll'], function () {
	var page={
		...
		onPageLoad:function(){
			//http://dev.o2omarketing.cn:9004/ApplicationInterface/Gateway.ashx?type=Product&action=UnitAndItem.Unit.GetDisplaynone&req=%7B%22CustomerID%22%3A%22e703dbedadd943abacf864531decdac1%22%2C%22UserID%22%3A%221bcef6a26d6a06a3bbdf808a1218159a%22%2C%22OpenID%22%3A%221bcef6a26d6a06a3bbdf808a1218159a%22%2C%22Token%22%3Anull%2C%22Parameters%22%3A%7B%7D%7D
			this.url="";
		...
		GetCityList:function(callback){
			var self =this;
			$.util.ajax({
				url:this.url+'/ApplicationInterface/Gateway.ashx',
