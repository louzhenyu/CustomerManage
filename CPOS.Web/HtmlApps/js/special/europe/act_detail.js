Jit.AM.defindPage({
    ...
    initLoad: function() {
        ...
        var tempBaseInfo = Jit.AM.getBaseAjaxParam();
        tempBaseInfo.customerId='75a232c2cf064b45b1b6393823d2431e'
    ...
    GetTicketHtml: function(datas) {
        ...
        for (var i = 0; i < datas.length; i++) {
            ...
            listHtml.appendFormat("<div class=\"list {0} {1} {3} clearfix\" data-explain=\"{2}\">", self.activityInfo.TicketID == dataInfo.TicketID ? 'on' : '', dataInfo.TicketMore <= 0 ? "not" : '', dataInfo.TicketRemark, dataInfo.TicketPrice ? 'price' : '');
