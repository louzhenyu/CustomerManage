Jit.AM.defindPage({
    ...
    onPageLoad: function() {
        var me = this;
        //分享设置
        var title=Jit.AM.getAppVersion().APP_WX_TITLE,
            imgUrl=Jit.AM.getAppVersion().APP_WX_ICO,
            desc="我发现一个不错的商品，赶紧来看看吧!";
       try{
         Jit.WX.shareFriends(title,"我发现一个不错的商品，赶紧来看看吧!",location.href,imgUrl);
        
        Jit.WX.shareTimeline(title,"我发现一个不错的商品，赶紧来看看吧!",location.href,imgUrl);
        }catch(e){
