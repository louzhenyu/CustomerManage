...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_Inout_ExpandBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_Inout_ExpandDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_Inout_ExpandBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_Inout_ExpandDAO(pUserInfo);
