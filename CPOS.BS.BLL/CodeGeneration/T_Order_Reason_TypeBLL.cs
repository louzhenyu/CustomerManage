...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_Order_Reason_TypeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_Order_Reason_TypeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_Order_Reason_TypeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_Order_Reason_TypeDAO(pUserInfo);
