...
{   
    ...
    public partial class VipCardBalanceChangeBLL
    {
        ...
        private VipCardBalanceChangeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardBalanceChangeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardBalanceChangeDAO(pUserInfo);
