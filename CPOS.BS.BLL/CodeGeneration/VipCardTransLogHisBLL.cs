...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipCardTransLogHisBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipCardTransLogHisDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardTransLogHisBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardTransLogHisDAO(pUserInfo);
