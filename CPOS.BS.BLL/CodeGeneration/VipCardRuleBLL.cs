...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipCardRuleBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipCardRuleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardRuleBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardRuleDAO(pUserInfo);
