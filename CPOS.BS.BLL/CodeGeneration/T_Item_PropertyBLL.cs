...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_Item_PropertyBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_Item_PropertyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_Item_PropertyBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_Item_PropertyDAO(pUserInfo);
