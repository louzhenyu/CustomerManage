...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_Item_Price_TypeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_Item_Price_TypeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_Item_Price_TypeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_Item_Price_TypeDAO(pUserInfo);
