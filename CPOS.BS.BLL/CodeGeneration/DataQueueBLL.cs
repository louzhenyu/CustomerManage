...
{   
    /// <summary>
    /// 业务处理： 队列表，用于通知或其他左右，支持重试多次 
    /// </summary>
    public partial class DataQueueBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private DataQueueDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public DataQueueBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new DataQueueDAO(pUserInfo);
        ...
        {
            return _currentDAO.Insert(pEntity);
        }
