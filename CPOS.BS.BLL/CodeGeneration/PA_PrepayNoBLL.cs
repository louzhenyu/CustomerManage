...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class PA_PrepayNoBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private PA_PrepayNoDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PA_PrepayNoBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new PA_PrepayNoDAO(pUserInfo);
