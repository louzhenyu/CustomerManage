...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipCardReRechargeProfitRuleBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipCardReRechargeProfitRuleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardReRechargeProfitRuleBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardReRechargeProfitRuleDAO(pUserInfo);
