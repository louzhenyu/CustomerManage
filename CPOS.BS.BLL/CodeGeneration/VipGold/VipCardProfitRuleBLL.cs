...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipCardProfitRuleBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipCardProfitRuleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardProfitRuleBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardProfitRuleDAO(pUserInfo);
