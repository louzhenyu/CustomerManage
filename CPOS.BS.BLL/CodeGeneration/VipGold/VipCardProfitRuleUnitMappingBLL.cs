...
{   
    ...
    public partial class VipCardProfitRuleUnitMappingBLL
    {
        ...
        private VipCardProfitRuleUnitMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardProfitRuleUnitMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardProfitRuleUnitMappingDAO(pUserInfo);
