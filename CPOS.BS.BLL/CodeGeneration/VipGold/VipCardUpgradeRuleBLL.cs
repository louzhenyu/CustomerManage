...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipCardUpgradeRuleBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipCardUpgradeRuleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardUpgradeRuleBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipCardUpgradeRuleDAO(pUserInfo);
