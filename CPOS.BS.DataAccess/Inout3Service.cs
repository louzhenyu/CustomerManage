        ...
        public DataSet GetInoutInfoById_lj(string order_id)
        {
            ...
            string sql = "select a.order_id "
                ...
                //积分折扣,下单是消费的积分20，订单返回给的积分	 21
                      + @",isnull( CONVERT(decimal(18,2),  ISNULL(   ISNULL((select SettingValue from CustomerBasicSetting  where SettingCode  ='IntegralAmountPer' and customerid=a.customer_id and isdelete=0)
	                    ,(select SettingValue from CustomerBasicSetting  where SettingCode  ='IntegralAmountPer' and customerid is null  and isdelete=0) )
