...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class MHAdAreaDAO : BaseCPOSDAO, ICRUDable<MHAdAreaEntity>, IQueryable<MHAdAreaEntity>
    {
        ...
        public DataSet GetModelTypeIdByGroupId(string groupId)
        {
            ...
            string sql = string.Format("select modelTypeId,modelname as modelTypeName from MHCategoryAreaGroup where groupValue = {0} and customerId = '{1}' and IsDelete=0", groupId, customerId);//要把删除的排除掉
