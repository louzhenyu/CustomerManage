...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class T_Inout_DetailDAO : Base.BaseCPOSDAO, ICRUDable<T_Inout_DetailEntity>, IQueryable<T_Inout_DetailEntity>
    {
        public T_Inout_DetailEntity[] GetByIDS(string[] IDS)
        {
            ...
            string sql = string.Format("select a.*,b.item_id,c.item_name,c.item_remark,(select top 1 imageurl from ObjectImages where ObjectId=b.item_id and isdelete=0 order by displayindex) imageurl from T_Inout_Detail a join t_sku b on a.sku_id=b.sku_id Join T_Item c on b.item_id=c.item_id where 1=1 {0}", sub);
